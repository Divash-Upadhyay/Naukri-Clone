      ...
      <div className={styled.footer}>
        <div className={`${styled.main_row} ${styled.flex}`}>
              ...
              <tbody className={styled.share_icon}>
                <td>
                  <img
                    ...
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBKp71Uq-A4LYdwRLCd8Qnl4yv_pQ7DjvFnA&usqp=CAU"
                    alt="google"
                  />
                </td>
                <br />
          ...
          <div className={styled.fotr_col_3}>
            ...
            <h3>Browse Jobs</h3>
            <a href="null">
              <td>Browse all job</td>
            </a>
            <br />
            <a href="null">
              <td>Premium MBA job</td>
            </a>
            <br />
            <a href="null">
              <td>Premium Engineering job</td>
            </a>
            <br />
            <a href="null">
              <td>Govt. job</td>
            ...
            <br />
            <a href="null">
              <td>Jobs by destination</td>
            </a>
            <br />
            <a href="null">
              <td>Jobs by location</td>
            </a>
            <br />
            <a href="null">
              <td>Jobs by skill</td>
          ...
          <div className={styled.fotr_col_4}>
            ...
            <a href="null">
              <td>Priority Applicant</td>
            </a>
            <br />
            <a href="null">
              <td>Resume display</td>
            </a>
            <br />
            <a href="null">
              <td>Resume writting</td>
            </a>
            <br />
            <a href="null">
              <td>Job4u</td>
            ...
            <br />
            <a href="null">
              <td>Recruiter Connection</td>
            </a>
            <br />
            <br />
            <h3>Naukri Learning</h3>
            <a href="null">
              <td>Softer and technology</td>
            </a>
            <br />
            <a href="null">
              <td>AI AND DS</td>
          ...
          <div className={styled.fotr_col_5}>
            ...
            <br />
            <a href="null">
              <td>By resume package online</td>
            </a>
            <br />
            <a href="null">
            ...
            <br />
            <a href="null">
              <td>Recruite from USA ,call</td>
            </a>
            <br />
            <a href="null">
              <td>Toll Free # 1866-557-3340</td>
            </a>
            <br />
            <br />
            <h3>Ambition Box</h3>
            <a href="null">
              <td>Inverview Question</td>
            </a>
            <br />
            <a href="null">
              <td>About Companies</td>
            </a>
            <br />
            <a href="null">
              <td>Share interview advice</td>
            </a>
            <br />
            <a href="null">
              <td>Write company review</td>
            </a>
            <br />
            <a href="null">
              <td>Companies reviews</td>
            </a>
            <br />
            <a href="null">
              <td>Companies salaries</td>
            </a>
            <br />
            <a href="null">
              <td>Follow us</td>
            ...
            <div className={styled.fotr_col_1}>
              {/* <tbody className={styled.share_icon}>
                <td>
                  <img
                    src="https://image.flaticon.com/icons/png/128/1384/1384053.png"
                    alt="facebook"
                  />
                </td>
                <td>
                ...
                <td>
                  <img
                    src="https://image.flaticon.com/icons/png/128/3256/3256016.png"
                    alt="linkedin"
                  />
                </td>
              </tbody> */}
